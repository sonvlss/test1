...
public class CameraController_Branches : MonoBehaviour
{
    ...
    {        
        while (true)
        {
            if (gameManager.GameState_BR != GameState_BR.GameOver && playerController.isPlayerRunning && !playerController.isRotatingTrunk && !playerController.touchDisable)
            {
